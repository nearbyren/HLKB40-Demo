...
public class BluetoothLeClass {
    ...
    public static String strResultInfoByStatus(int status) {
        ...
        switch (status) {
            case 0:
                strInfo = "A GATT operation completed successfully";
                break;
            case 2:
                strInfo = "GATT read operation is not permitted";
                break;
            case 3:
                strInfo = "GATT write operation is not permitted";
                break;
            case 5:
                strInfo = "Insufficient authentication for a given operation";
                break;
            case 6:
                strInfo = "The given request is not supported";
                break;
            case 7:
                strInfo = "A read or write operation was requested with an invalid offset";
                break;
            case 0xf:
                strInfo = "Insufficient encryption for a given operation";
                break;
            case 0xd:
                strInfo = "A write operation exceeds the maximum length of the attribute";
                break;
            case 0x8f:
                strInfo = "A remote device connection is congested.";
                break;
            case 0x101:
                strInfo = "A GATT operation failed, errors other than the above";
                break;
        }
        return strInfo;
    }
    ...
    public interface OnRecvDataListerner {
        public void OnCharacteristicRecv(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic);
...
//			characteristic);
    ...
    public boolean connect(BluetoothDevice device, OnConnectListener l) {
        if (l != null) mOnConnectListener = l;
